...
raw_table2 = excelF.iloc[14:22, 1:9]  # Include row 21 for Dankoffer data (rows 14-21)
...
verse_text = _get(table2, 4, ["Tekst", "tekst", "Text", "text"])  # Verse text from Tekst column, row 21
