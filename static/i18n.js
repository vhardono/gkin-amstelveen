const GKIN_I18N = {
  nl: {
    ...
    'wa.download_meded':      'Download Mededelingen',
    'wa.download_bijlagen':   'Download Bijlagen',
    ...
    'wa.reminder':            '⏰ Stuur dit bericht uiterlijk zaterdag naar de <strong>Kerkenraad GKIN AM</strong> WhatsApp groep. Voeg Liturgie toe als bijlage.',
    'wa.modal_title':         'WA-OLE informatie',
    'wa.loading':             'OLE preekroster laden...',
    'wa.loading_tikkie':      'Tikkie ophalen...',
    'wa.copy':                'Kopiëren',
    ...
    'lit.translate_ask':      'Wil je de preek eerst vertalen?',
    'lit.translate_yes':      'Ja, vertaal preek (NL↔ID)',
    'lit.translate_no':       'Nee, preek is al vertaald',
    'lit.translate_busy':     'Bezig met vertalen… Dit kan een minuut duren.',
    'lit.translate_done':     '✓ Vertaling gereed:',
    'lit.translate_download': 'Download vertaling',
    'lit.translate_use':      'Gebruik vertaling voor liturgie',
  ...
  id: {
    ...
    'wa.download_meded':      'Unduh Mededelingen',
    'wa.download_bijlagen':   'Unduh Lampiran',
    ...
    'wa.reminder':            '⏰ Kirim pesan ini paling lambat hari Sabtu ke grup WhatsApp <strong>Kerkenraad GKIN AM</strong>. Lampirkan Liturgi sebagai lampiran.',
    'wa.modal_title':         'Info WA-OLE',
    'wa.loading':             'Memuat jadwal OLE...',
    'wa.loading_tikkie':      'Mengambil Tikkie...',
    'wa.copy':                'Salin',
    'wa.copied':              '✓ Tersalin!',
    ...
    'lit.translate_ask':      'Apakah kamu ingin menerjemahkan khotbah ini?',
    'lit.translate_yes':      'Ya, terjemahkan (NL↔ID)',
    'lit.translate_no':       'Tidak, teks sudah diterjemahkan',
    'lit.translate_busy':     'Sedang menerjemahkan… Ini mungkin membutuhkan satu menit.',
    'lit.translate_done':     '✓ Terjemahan selesai:',
    'lit.translate_download': 'Unduh terjemahan',
    'lit.translate_use':      'Gunakan terjemahan untuk liturgi',
  ...
  en: {
    ...
    'wa.download_meded':      'Download Mededelingen',
    'wa.download_bijlagen':   'Download Attachments',
    ...
    'wa.reminder':            '⏰ Send this message by Saturday at the latest to the <strong>Kerkenraad GKIN AM</strong> WhatsApp group. Attach the Liturgy as attachment.',
    'wa.modal_title':         'WA-OLE information',
    'wa.loading':             'Loading OLE roster...',
    'wa.loading_tikkie':      'Fetching Tikkie...',
    'wa.copy':                'Copy',
    'wa.copied':              '✓ Copied!',
    ...
    'lit.translate_ask':      'Do you want to translate the preek first?',
    'lit.translate_yes':      'Yes, translate preek (NL↔ID)',
    'lit.translate_no':       'No, preek is already translated',
    'lit.translate_busy':     'Translating… This may take a minute.',
    'lit.translate_done':     '✓ Translation ready:',
    'lit.translate_download': 'Download translation',
    'lit.translate_use':      'Use translation for liturgy',
